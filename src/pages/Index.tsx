...
const DigitalLiteracyTest = () => {
  ...
  const tasks = [
    ...
    },
    {
      ...
      success: () => searchQuery === "digital literacy definition" && searchResults.length > 0,
  ...
  const restoreWindow = (id) => {
    ...
    // Check if task is completed after restoring
    setTimeout(checkTaskCompletion, 100);
  };
  ...
  // Perform search
  const handleSearch = () => {
    if (searchQuery.toLowerCase().includes("digital literacy")) {
      ...
      setSearchResults([
        {
          ...
          url: `https://search-engine.com/results?q=${searchQuery}`,
            ...
            content: `
              <div>
                ...
                <div class="text-sm">
                  <div class="font-bold mb-1">Search results for: ${searchQuery}</div>
                  <div class="mb-2 p-1">
                    <div class="font-bold text-blue-600 underline cursor-pointer">Results for: ${searchQuery}</div>
                    <div class="text-green-800 text-xs">https://search-engine.com/results?q=${searchQuery}</div>
  ...
  useEffect(() => {
    const handleWindowClicks = () => {
      if (isLoggedIn) {
        ...
        // Find Internet Explorer search input
      ...
      return () => {
        ...
        const searchInput = document.getElementById("search-input");
        if (searchInput) {
          searchInput.removeEventListener("change", (e) => {
            setSearchQuery(e.target.value);
          });
